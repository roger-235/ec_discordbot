      ...
      fetch(`/api/posts/${postId}`)
        ...
        .then((post) => {
          setForm({
            ...
            eventTime: post.eventTime ? post.eventTime.slice(0, 10) : "",
          })
          setFetching(false)
        })
    })
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-3">
      <div className="pcb-card px-8 py-5">
        ...
        <span className="silk block mb-2">WRITE · EDIT-POST</span>
        <h1 className="text-3xl font-black text-[#e8f0e8]">編輯活動</h1>
      </div>
